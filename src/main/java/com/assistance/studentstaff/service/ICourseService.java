...
public interface ICourseService {
	...
	List<CourseModel> fetchAllCourse() throws CustomGenericException;
	
	List<CourseModel> fetchAllCourseByDeptAndProg(String deptId, String progId) throws CustomGenericException;
